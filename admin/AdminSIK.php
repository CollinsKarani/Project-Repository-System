                  ...
                  <div class="span12">
                    <div class="widget purple">
                        ...
                        <div class="widget-body form">
                            ...
                            <tbody>
                           <?php
                              $result = $conn ->prepare("SELECT * FROM project_tbl WHERE studentRegNo LIKE'%SIK%'");
                              $result ->execute();
                       ...
                       <td><?php echo $project['studentRegNo']; ?></td>
                          ...
                          <td><a href="../uploads/documentation/<?php echo $project['project_documentation']; ?>">Download</a></td>
