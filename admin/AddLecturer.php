      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
            ...
            <!-- END PAGE HEADER-->
                        ...
                        <div class="widget-body">
                            <?php
                              if(isset($_POST['register'])){
                                  ...
                                  $register=$conn->prepare("INSERT INTO staff_tbl (pfnumber,departmentID,firstname,middlename,lastname,email,phone_number) VALUES('$pf','$dept','$fname','$mname','$lname','$email','$phone')");
                                  if($register->execute()){
             ...
             <input type="text" class="form-control" name="pfnumber" />
         </div> </div>
                               <div class="span4"> <div class="form-group">
         ...
         <div class="row-fluid">
             ...
             <select class="form-control" name="departmentID">
                 ...
                 <?php
                 $dept=$conn->prepare("SELECT * FROM department_tbl");
                 $dept->execute();
                 ...
                 ?>
                      ...
                      <div class="span4"> <div class="form-group">
            <button type="submit" name="register" class="btn btn-primary">Register Staff</button>
         </div></div>
                          </div>
                      </div>
