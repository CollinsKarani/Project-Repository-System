...
$stmt = $conn->prepare("SELECT * FROM student_tbl INNER JOIN login_tbl ON (login_tbl.username=student_tbl.student_regno) WHERE login_tbl.username=:uid");
                   ...
                   <li class="dropdown mtop5">
                       ...
                       <li class="dropdown dropdown-user">
                           <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                               ...
                               <span class="username"> <?php echo $row['first_name'].' '.$row['lastname']; ?></span>
                               <b class="caret"></b>
                           </a>
                           <ul class="dropdown-menu extended logout">
							...
							<a href="#"><i class="icon-calendar"></i> My Calendar </a> </li>
                               ...
                               <li><a href="../logout.php"><i class="icon-key"></i> Log Out&nbsp; &nbsp;<strong>(<?php echo  $row['student_regno'];?>)</strong></a></li>
                           </ul>
                       </li>
