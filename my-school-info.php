                 ...
                 <div class=" profile span12">
                     <div class="span2">
                       ...
                       <a href="enrolment-profile" class="profile-features">
                         ...
                         <a href="my-school-info" class="profile-features active">
                     ...
                     <div class="span10">
                         <div class="profile-head">
                             <div class="span4">
                                 ...
                                 <p>Alumni of <a href="#">Miathene Boys</a></p>
                             </div>
                         ...
                         <div class="row-fluid">
                             <div class="span12">
                                    <div class="widget purple">
                                         <div class="widget-title">
                                          <h4><i class="icon-phone"></i> Education Level Information&nbsp;&nbsp;[<?php echo  $row['FullName']; ?>]</h4>
                                           <span class="tools">
		                 	...
		                 	?>
			             <tr>
			           <td><?php echo $update['PriSchool']; ?></td>
                          <td><?php echo $update['schoolType']; ?></td>
                          <td><?php echo $update['yearStart']; ?></td>
                          <td><?php echo $update['yearEnd']; ?></td>
                           <td><?php echo $update['PriSchMarks']; ?></td>
                          <td><?php echo $update['grade']; ?></td>
                           <td><?php echo $update['indexNo']; ?></td>
                          <td><a href='schoolupdate.php'><button class='btn btn-primary'><i class='icon-pencil'></i>Edit</button></a></td>
