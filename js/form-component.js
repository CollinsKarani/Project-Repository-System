var Script = function () {
    ...
    $('#reportrange').daterangepicker(
        ...
        function(start, end) {
            $('#reportrange span').html(start.toString('yyy d, MMM') + ' - ' + end.toString('yyy d, MMM'));
        }
    );

    //Set the initial state of the picker label
    $('#reportrange span').html(Date.today().add({ days: -29 }).toString('yyy d, MMM') + ' - ' + Date.today().toString('yyy d, MMMM'));
