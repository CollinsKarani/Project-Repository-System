          ...
          <ul class="sidebar-menu">
              <li class="sub-menu active">
                  <a class="" href="javascript:;">
                   ...
                   <ul class="sub">
                      <li class="active"><a class="" href="#.php">Home</a></li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    <div class="metro-nav-block nav-block-orange">
                        <a data-original-title="" href="LecCOM.php">
                            <i class="icon-book"></i>
                            <div class="info"></div>
                    ...
                    <div class="metro-nav-block nav-olive">
                        <a data-original-title="" href="LecSIT.php">
                            <i class="icon-calendar"></i>
                            <div class="info"></div>
                    ...
                    <div class="metro-nav-block nav-block-yellow">
                        <a data-original-title="" href="LecSIK.php">
                    ...
                    <div class="metro-nav-block nav-block-green double">
                        <a data-original-title="" href="LecETS.php">
                            <i class="icon-calendar"></i>
                            <div class="info"></div>
